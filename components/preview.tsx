        ...
        <li className='flex gap-4 py-10 border-b [&:first-child]:border-t' key={index}>
            ...
            <div>
                ...
                <Link href={`/posts/${slug}`}>
                    <a className='text-indigo-500 font-bold text-lg hover:underline'>Read more</a>
                </Link>
            </div>
        </li>
    )
